...
\footnotetext{I deliberately left out the units, because the actual number were for each measurement different, depending on how much I was accelerating, changing directions or rotating with the device, but the tendency and shape of the curve was always the same.}
